...
CREATE TABLE prismhr2."Attendance" (
  ...
  "totalOtHour" double precision DEFAULT '0'::double precision NOT NULL,
...
CREATE TABLE prismhr2."Pay" (
  ...
  "totalRegularDays" double precision DEFAULT '0'::double precision NOT NULL,
  "totalExtraDays" integer,
  "totalPhDays" integer,
  "totalToolbox" double precision DEFAULT '0'::double precision,
  "totalTravel" double precision DEFAULT '0'::double precision,
  "totalLunchHours" double precision DEFAULT '0'::double precision,
  "totalOtHours" double precision DEFAULT '0'::double precision,
  "totalExtraDaysOt" double precision DEFAULT '0'::double precision,
  "totalPhDaysOt" double precision DEFAULT '0'::double precision,
  ...
  "totalPhDaysPay" double precision DEFAULT '0'::double precision,
  "totalToolboxPay" double precision DEFAULT '0'::double precision,
  "totalTravelPay" double precision DEFAULT '0'::double precision,
  "totalLunchPay" double precision DEFAULT '0'::double precision,
  "totalOtPay" double precision DEFAULT '0'::double precision,
  "totalExtraDaysOtPay" double precision DEFAULT '0'::double precision,
  "totalPhDaysOtPay" double precision DEFAULT '0'::double precision,
