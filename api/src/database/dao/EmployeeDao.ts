...
export const get = async (offset: number, limit: number, q?: string): Promise<EmployeeDetailsResponseModel[]> => {
  ...
  const result: EmployeeDetailsResponseModel[] = await sequelize.query(
    `SELECT e.*, a."lunchHours", p."totalRegularDays", p."totalExtraDays",  p."totalPhDays", p."totalOtHours", p."totalExtraDaysOt", p."totalPhDaysOt", p."totalRegularPay", p."totalExtraDaysPay", p."totalPhDaysPay", p."totalOtPay",  p."totalExtraDaysOtPay", p."totalPhDaysOtPay", p."totalPay"
